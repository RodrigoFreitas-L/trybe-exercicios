...
const botMsg = estudantes.find((element) => {
  if (element.status < 80) console.log(`Olá ${element.nome}, o prazo para entrega do projeto é daqui a 3 dias, vc precisa de alguma ajuda?`);
}
);
