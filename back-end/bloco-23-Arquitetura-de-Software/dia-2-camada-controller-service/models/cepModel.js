...
//   const removeScore = cep.toString().replace(/-/g, '');
//   const [result] = await connection.execute(`SELECT cep, logradouro, bairro, localidade, uf FROM ceps WHERE cep = ?`,[removeScore]);
...
const create = async (cep, logradouro, bairro, localidade, uf) => {
  ...
  await connection.execute(`INSERT INTO ceps (cep, logradouro, bairro, localidade, uf) VALUES (?, ?, ?, ?, ?)`, [rawCep, logradouro, bairro, localidade, uf]);
